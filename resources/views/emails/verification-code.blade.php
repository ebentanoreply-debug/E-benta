...
<head>
    ...
    <title>Verify Your E-Benta Email Address</title>
    <!--[if mso]>
    <noscript>
        <xml>
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center">
                                        ...
                                        <p style="margin: 6px 0 0 0; color: #e6fffa; font-size: 14px; font-weight: 500; letter-spacing: 0.3px;">Email Verification Code</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td class="content-cell" style="padding: 36px 32px 28px 32px; background-color: #ffffff;">
                            <p style="margin: 0 0 16px 0; font-size: 16px; line-height: 1.6; color: #334155;">
                                Welcome to E-Benta, <strong style="color: #0f172a;">{{ $user->name }}</strong>! 🎉
                            </p>
                            <p style="margin: 0 0 24px 0; font-size: 15px; line-height: 1.6; color: #475569;">
                                Please confirm your email address to complete your registration. Enter the 6-digit verification code below:
                            </p>
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 20px 0 28px 0;">
                                <tr>
                                    <td align="center" style="background: #f8fafc; border: 2px dashed #0d9488; border-radius: 12px; padding: 24px 16px;">
                                        <span style="display: block; font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 2px; color: #0d9488; margin-bottom: 10px;">Your 6-Digit Code</span>
                                ...
                                <tr>
                                    <td style="padding: 12px 16px;">
                                        <p style="margin: 0; font-size: 13px; line-height: 1.5; color: #92400e;">
                                            ⏱️ <strong>Expires in 15 minutes.</strong> If the code expires, you can request a new one from the verification screen.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td style="padding: 14px 16px;">
                                        ...
                                        <p style="margin: 0; font-size: 12px; line-height: 1.5; color: #64748b;">
                                            Never share your verification code with anyone. E-Benta team members will never ask for this code.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="background-color: #f8fafc; padding: 22px 30px; text-align: center; border-top: 1px solid #e2e8f0;">
                            <p style="margin: 0 0 6px 0; font-size: 12px; color: #64748b; font-weight: 500;">
                                E-Benta Marketplace & Refurbished Electronics Platform
                            </p>
