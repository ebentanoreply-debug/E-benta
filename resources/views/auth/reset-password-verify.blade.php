...
@section('title', 'Verify Reset Code - E-Benta')
...
<div class="reset-password-container">
    <div class="reset-password-card">
        <div class="reset-password-header">
            ...
            <p>Step 1 of 2: Confirm your 6-digit code</p>
        </div>
        <div class="reset-password-body">
            @if ($errors->any())
                <div class="error-box">
                    <p><i class="fas fa-exclamation-circle me-2"></i>Please fix the following:</p>
            ...
            <div class="info-text">
                ...
                <span>Please enter the 6-digit verification code sent to your email. The code expires in 15 minutes.</span>
            </div>
            ...
            <form method="POST" action="{{ route('password.verify-code') }}">
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <label for="code" class="mb-0">
                            <i class="fas fa-key me-2" style="color: var(--light-green);"></i>6-Digit Reset Code
                        </label>
                    ...
                    <input type="text" class="form-control otp-input @error('code') is-invalid @enderror" 
                         id="code" name="code" value="{{ old('code', $code) }}" placeholder="000000" maxlength="6" pattern="[0-9]{6}" inputmode="numeric" autocomplete="one-time-code" required autofocus>
                    @error('code')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <button type="submit" class="submit-btn">
                    <i class="fas fa-arrow-right me-2"></i>Verify Code & Continue
                </button>
            </form>
