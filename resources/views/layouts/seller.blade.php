...
<body style="background-color: #09171f; color: #e2e8f0; padding-top: 0;">
    ...
    <nav class="seller-topbar-nav" aria-label="Seller Portal Topbar">
        ...
        <div class="d-flex align-items-center gap-1 gap-sm-2 flex-shrink-0">
            ...
            <a href="{{ route('seller.dashboard') }}" class="d-flex align-items-center gap-2 text-decoration-none ms-1">
                <div style="width: 30px; height: 30px; border-radius: 8px; background: linear-gradient(135deg, #0d9488 0%, #10b981 100%);
                            display: flex; align-items: center; justify-content: center; box-shadow: 0 3px 8px rgba(13,148,136,0.35); flex-shrink: 0;">
                ...
                <div class="d-none d-sm-flex flex-column" style="line-height: 1.1;">
                    ...
                    <span class="d-none d-md-inline" style="color: #10b981; font-size: 0.6rem; font-weight: 800; text-transform: uppercase; letter-spacing: 0.5px;">Seller Studio</span>
                </div>
            </a>
        </div>
        ...
        <div class="d-flex align-items-center gap-1 gap-sm-2 flex-shrink-0">
            ...
            <div class="dropdown">
                <button type="button" data-bs-toggle="dropdown" aria-expanded="false"
                    style="display: flex; align-items: center; gap: 0.4rem; background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.12);
                    ...
                    <span class="d-none d-lg-inline" style="font-size: 0.82rem; font-weight: 700; color: #ffffff;">{{ Str::limit(auth()->user()->name, 14) }}</span>
                ...
                <ul class="dropdown-menu dropdown-menu-end" style="background: #0f172a; border: 1px solid rgba(13,148,136,0.3); border-radius: 0.8rem; min-width: 210px;">
                    ...
                    <li style="padding: 0.35rem 0;">
                        ...
                        <a href="{{ route('seller.listings') }}" style="display: flex; align-items: center; gap: 0.65rem; padding: 0.6rem 1rem; color: #94a3b8; text-decoration: none; font-size: 0.88rem; font-weight: 600; transition: all 0.2s ease;" onmouseover="this.style.background='rgba(13,148,136,0.1)'; this.style.color='#ffffff';" onmouseout="this.style.background='transparent'; this.style.color='#94a3b8';"><i class="fas fa-boxes-stacked" style="width: 18px; color: #38bdf8;"></i> My Inventory</a>
                        <a href="{{ route('listings.create') }}" style="display: flex; align-items: center; gap: 0.65rem; padding: 0.6rem 1rem; color: #94a3b8; text-decoration: none; font-size: 0.88rem; font-weight: 600; transition: all 0.2s ease;" onmouseover="this.style.background='rgba(13,148,136,0.1)'; this.style.color='#ffffff';" onmouseout="this.style.background='transparent'; this.style.color='#94a3b8';"><i class="fas fa-plus-circle" style="width: 18px; color: #34d399;"></i> List New Tech</a>
                    </li>
