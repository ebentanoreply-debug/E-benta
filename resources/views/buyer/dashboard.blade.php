...
<div class="buyer-dashboard-page py-4">
    <div class="container-fluid px-3 px-lg-4">
        <div class="row g-4">
            ...
            <main class="col-lg-9 col-xl-9">
                ...
                <!-- HERO HEADER -->
                <div class="buyer-hero-header mb-4">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 position-relative" style="z-index: 1;">
                        <div>
                            ...
                            <h1 style="font-size: clamp(1.6rem, 2.3vw, 2.2rem); font-weight: 900; margin: 0; letter-spacing: -0.5px; color: #ffffff;">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <div style="width: 38px; height: 38px; border-radius: 0.5rem; background: #f1f5f9; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0;">
                                                        ...
                                                        @endphp
                                                        @if($firstPhoto)
                                                            <img src="{{ $firstPhoto }}" alt="Item" style="width: 100%; height: 100%; object-fit: cover;">
                                                        @else
