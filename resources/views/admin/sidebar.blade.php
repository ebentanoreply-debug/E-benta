...
<div class="admin-sidebar" style="position: fixed; left: 0; top: 0; width: 260px; height: 100vh; display: flex; flex-direction: column; z-index: 1030; overflow-y: auto;">
    <!-- Sidebar Header -->
    ...
    <nav style="flex: 1; overflow-y: auto; padding: 1rem 0;">
        ...
        <p class="sidebar-section-title">Content Management</p>
        ...
        <p class="sidebar-section-title">Analytics & Reports</p>
        ...
        <p class="sidebar-section-title">Security & Monitoring</p>
